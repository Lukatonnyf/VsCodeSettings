...
@bot.command()
async def ola(ctx: commands.Context): # Aqui estamos Tipando o comando ctx como um Objeto do tipo Context
  ...
  await ctx.reply(f"Olá, {nome}! Tudo bem?") # Aqui o bot vai responder com a mensagem "Olá, tudo bem?" quando o comando for chamado
