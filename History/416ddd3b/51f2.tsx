                    ...
                    className="flex  justify-start items-center w-full h-[10dvh]
                     ...
                     sm:gap-5 lg:max-w-[40dvh] lg:max-h-[9dvh] hover:scale-105 transition ">
                      ...
                      <div className="flex flex-col gap-1">
                            <h1 className="text-gray-200 font-heading font-semibold sm:text-xl xl:text-xl ">{skills.label}</h1>
                            <span className="text-gray-400 font-sans font-semibold sm:text-sm xl:text-sm">{skills.desc}</span>
                        </div>    
