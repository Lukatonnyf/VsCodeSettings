    ...
    return(
          ...
          <div className="w-full h-full bg-blue p-3 pt-4 flex flex-col  justify-center items-center  gap-5 md:flex-row md:flex-wrap"> 
          {
            ...
            <Image 
             ...
             <button type="button" className="mt-1 py-2 p-2 w-[15dvh] text-gray-100 bg-btn rounded-2xl  font-sans text-sm transition hover:bg-btn-hover" onClick={() => irCertificado(certificadosCursos.linkCertificado)}>Ir para o projeto</button>
            </div>
          </div>  
            )
          }
