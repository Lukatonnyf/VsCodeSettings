 ...
 const irCertificado = (url: string) => {
    ...
    return(
          ...
          <div className="w-full h-full bg-blue p-3 pt-4 flex flex-col  justify-center items-center  gap-5 md:flex-row md:flex-wrap"> 
          {
            ...
            <div key={certificadosCursos.id} className="max-w-[35dvh] w-full max-h-[40dvh] h-full flex flex-col justify-between  items-start  p-2 pb-5 border border-gray-500 bg-gray-600 gap-2 rounded-2xl sm:w-[35dvh] sm:h-[30dvh] transition  sm:hover:scale-105">
            <Image 
