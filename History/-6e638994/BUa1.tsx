...
const ButtonsArray: ButtonsProps[] = [
  {
    id: 1,
    text: "Discord",
    url: 'https://discord.gg/2YsrZsnP'
  },
  {
    id: 2,
    text: "GitHub",
    url: 'https://github.com/Lukatonnyf'

  },
  {
    id: 3,
    text: "Linkedin",
    url: 'https://www.linkedin.com/in/lukatonny-ferreira/'
  }
]
        ...
        <section className=" w-full  px-5 flex flex-wrap justify-center items-center gap-3 sm:gap-5 text-black">
          ...
          (
            <div
              ...
              key={item.id}
              className=" animate-rotate-border     rounded-lg
          ...
          ">
            ...
            text-text-color duration-300 ease-in hover:scale-110 shadow-lg hover:shadow-blue-400 ">{item.text}</Button>
              </a>
            </div>
          ))
          }
