...
export default function VsAboutMe(){
    ...
    return(
        <div className="w-full h-full "> 
         <div className="pl-1">    
          <div className="flex flex-row p-5 bg-blue ">
            <span>
              <ul>
                {lineNumbers}
              </ul>
       ...
       <div className="flex flex-col gap-2 w-full">
        <JsxAboutMe/>
            ...
            {/* Return/Main  */}
                <div>
                    <h1 className="flex flex-col mt-6 pl-1 text-danger">
                        return &#40;
                    ...
                    {/* role */}
                    <p className="pl-5 text-tags">&#60;p&#62;&#123;role.name&#125;&#60;&#47;p&#62;</p>
                    {/* age */}
                    <p className="pl-5 text-tags">&#60;p&#62;&#123;age.name&#125;&#60;&#47;p&#62;</p>
                    <p className="pl-2 text-tags">
                            &#60;&#47;main&#62;
                        </p>
                    &#41;&#59;
