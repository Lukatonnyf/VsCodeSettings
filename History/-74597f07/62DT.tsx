    ...
    <div className="w-full h-full">
      <div className="flex flex-row p-5 gap-5">
        ...
        <ul className="w-full min-h-full flex flex-col items-start gap-2">
          <h1 className=" flex  flex-row items-center gap-2 text-gray-200 font-heading text-md">
          ...
          {socialMedias.map(social => (
            ...
            >
              <Image
                ...
                className="size-6  "
              />
              <button type="button" className='text-sm sm:text-md' onClick={() => irSocialMedias(social.btn)}>
                {social.text}
              </button>
            </li>
          ))}
