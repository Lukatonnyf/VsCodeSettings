    ...
    <div className="flex flex-col justify-center items-center
     ...
     bg-gradient-to-t from-black to-[#121212]">
      ...
      >
        ...
        <div className='lg:ml-5 mb-7 md:mb-0 w-full h-full flex-col  justify-center items-center
         p-5'>
          ...
          <div
            ...
            <header className='flex flex-col justify-center items-center  text-center '>
              ...
              <div className='mt-5 '>
                ...
                <p className='text-gray-200'>Nossa Origem</p>
              </div>
            </header>
          ...
          <div
            ...
            <div>
              ...
              <p className='text-sm sm:text-base text-gray-300'>
                ...
                da curadoria cuidadosa de produtos e do atendimento personalizado. Cada perfume em nosso catálogo é selecionado
                pensando em quem valoriza a elegância, a autenticidade e a qualidade.
              </p>
            </div>
