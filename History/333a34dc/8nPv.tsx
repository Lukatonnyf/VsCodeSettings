...
const Input = () => {
  ...
  return (
    <div className=" border  border-red-600 flex justify-center items-center h-full">
      <div
        ref={containerRef}
        style={{ border: '2px solid #29292D' }}
        className=" flex flex-col justify-between py-1 px-5
       w-[80dvw]  bg-bg-secondcolor text-gray-100 rounded-3xl">
        ...
        <TextareaAutosize placeholder="Digite Sua Mensagem"
          ...
          maxRows={6}
          value={text}
          className="w-full h-full  py-2 border
