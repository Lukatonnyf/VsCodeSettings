...
import { Geist_Mono, Sansita, Tienne } from "next/font/google";
// import images
      ...
      gsap.fromTo(titleRef.current,
        { opacity: 0, y: 50 },
        {
          opacity: 1, y: 0, scrollTrigger: {
            trigger: titleRef.current, // O card será o trigger para a animação
            start: "top 80%",
            end: "top 30%",
            toggleActions: "play none none reverse",
          },
            ...
            ArrayFragances.map((frag, index) => (
              ...
              >
                ...
                <article className='flex flex-col justify-center text-start gap-1 lg:h-[20dvh] '>
                  <p className="flex flex-row text-lg gap-2md:text-2xl lg:text-lg">
                    <span ref={titleRef} className={`${geistMono.variable} text-white`}>{frag.title}</span>
                  </p>
