       ...
       h-full mt-16 bg-blue-300 p-5'>
        ...
        <div className='flex gap-5 bg-secondary container mx-auto   max-w-3xl py-8 px-4 '>
          ...
          <div className='flex flex-col justify-between gap-2'>
            <p className='flex flex-col uppercase font-bold text-xl'>{user.name}
              <span className='text-base font-normal dark:text-gray-400'>{user.email}</span>
            </p>
            <p className='dark:text-gray-400'>Cadastrado em: {new Date(user.subscribedAt).toLocaleDateString()}</p>
