...
export default function HomePage() {
  return (
    <div className="w-full h-screen px-5 py-2 flex justify-center overflow-hidden shadow-custom-purple-700">
      ...
      px-5 lg:flex-row">
        <section className="flex flex-col justify-center items-center p-5 w-full h-full gap-3 lg:gap-10">
          ...
          <div className="flex flex-col w-full max-w-2xl py-2 gap-3">
            <div className="flex flex-col justify-center items-center gap-2 h-full">
              ...
              <div className="text-center flex flex-col justify-center items-center">
                ...
                <p className="text-colortext text-base">Frontend Developer</p>
              </div>
