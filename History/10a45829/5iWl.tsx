...
import Carousel from "./carousel";  // Importe o Carousel
...
export default function FeedbackItemProps() {
  ...
  async function loadFeedbacks() {
    try {
      const response = await api.get("https://fraganciadivina-freelancer.onrender.com/feedbacks");
  ...
  to-[#121212]
    ...
    text-2xl font-bold mb-4">
        ...
        <h2 ref={titleRef} className="text-2xl font-bold mb-6 text-center text-gray-200 ">Feedbacks Recebidos</h2>
      ...
      </div>
      {
        showForm &&
        (
          <FormFeedback onSubmitAction={handleNewFeedback} show={showForm} setShow={setShowForm} innerRef={test} />
        )
