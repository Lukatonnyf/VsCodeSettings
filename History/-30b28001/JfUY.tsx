...
// => o React.FC significa: React Function
// => <FeedbackListProps>: o interface que vai receber os feedbacks em forma de Array
// => ({feedbacks}): Os feedbacks desestruturados, ao invés de usar (props.feedbacks),
// pegamos os feedbacks diretamente os desestruturando
