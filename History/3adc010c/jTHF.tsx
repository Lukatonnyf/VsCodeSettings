        ...
        <div className="w-full h-full flex  justify-center items-center p-5  flex-col  gap-5 md:flex-row md:flex-wrap"> 
           
            {
                MyProjects.map((project) => (
                    ...
                    <button className="mt-1 py-2 p-2 w-[20dvh] text-gray-100 bg-btn rounded-2xl  font-sans text-sm hover:bg-btn-hover" onClick={() => irProjeto(project.btn)}>Ir para o projeto</button>
                  </div>
