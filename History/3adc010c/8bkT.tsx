      ...
      {MyProjects.map(project => (
        ...
        >
          ...
          <div className="h-[10dvh] gap-0 m-0">
            <h1 className="text-purple font-heading font-semibold text-xl md:text-4xl">
              {project.name}
            </h1>
            <p className="text-gray-400 font-sans font-semibold text-sm sm:text-sm  md:text-2xl">
              {project.description}
            </p>
          </div>
          <button
            ...
            text-sm transition hover:bg-btn-hover md:text-2xl"
