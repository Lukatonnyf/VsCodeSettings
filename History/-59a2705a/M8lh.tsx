...
export default function AsideVsInterface({
  ...
  return (
    ...
    >
      <section className="flex flex-col justify-between border border-vscode-asidebackground  w-[6dvh] ">
      ...
      <section className="hidden w-full lg:flex flex-col ">
        <div
        className="flex flex-row justify-between w-full max-h-[5dvh] items-center
        text-vscode-items-color p-2"
        >
        ...
        <div className="w-full h-full ">
          <ul className="flex  flex-col pl-1 ">
            {LenguageUsedArray.map(lenguages => (
              <li
                key={lenguages.id}
                className="flex flex-row items-center gap-1 text-numbers-vscode"
              >
                <Image
