...
export default function ListaDados({ className }: { className: string; }) {
  ...
  useLayoutEffect(() => {
    if (dados.length === 0 || !scrollContainerRef.current) return;
        ...
        const anim = gsap.fromTo(
          ...
          { opacity: 0, y: 50 },
          {
            ...
            scrollTrigger: {
              ...
              markers: true, // 🔧 Use para debug visual
            },
          }
        );
    ...
    // 🔥 Muito importante! Recalcula os triggers
  ...
  return (
    <div
      ...
      className={`${className} overflow-y-auto flex h-full w-full  justify-center bg-red-4`}>
