  ...
  return (
    <div className="w-full min-h-[100dvh] px-5 flex items-baseline-last justify-center
     shadow-custom-purple-700 overflow-y-hidden">
      ...
      lg:flex-row max-w-[1240px] relative z-10 border border-borderbd'>
        <Image
          src='/ss.png'
          alt="test "
          priority
          fill
          className="object-cover object-left-bottom lg:object-center-bottom -z-10 absolute  rounded-t-xl "
