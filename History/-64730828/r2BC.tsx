  ...
  return (
    <div className="flex flex-col text-danger min-w-full gap-1  text-sm ">
      <div className="flex flex-col ">
        ...
        <h3 className=" text-gray-400 flex flex-col pl-2">
          <span className="flex gap-1">
            nome: <p className="text-blue">string,</p>
          </span>
          <span className="flex gap-1">
            funcao: <p className="text-blue">string,</p>
          </span>
          <span className="flex gap-1">
            idade: <p className="text-blue">number</p>
          </span>
        </h3>
        &#125;
      </div>
      ...
      <h2 className="flex flex-col  pl-2 text-metodos">
        <div className="flex flex-row flex-wrap gap-1 sm:gap-0 ">
          const aboutMe
