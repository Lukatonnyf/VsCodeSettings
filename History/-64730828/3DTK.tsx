        ...
        <div className="flex flex-col text-danger min-w-full overflow-auto  ">  
            ...
            <div className="flex flex-col  ">
                ...
                <h3 className=" text-gray-400 flex flex-col pl-2">
                    <span className="flex gap-1">name: <p className="text-blue">string,</p></span>
                    <span className="flex gap-1">role: <p className="text-blue">string,</p></span>
                    <span className="flex gap-1">age: <p className="text-blue">number</p></span>
                </h3>
                &#125;
            </div>
