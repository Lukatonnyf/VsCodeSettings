...
const Carousel: React.FC<CarouselProps> = ({ items, autoplayInterval = 2000 }) => {
  ...
  return (
    <div
      className="relative w-full max-w-full mx-auto overflow-hidden py-4 border border-blue-300"
        ...
        {displayedItems.map((item, index) => (
          ...
          >
            <Image
              ...
              width={LOGO_WIDTH}
              height={80}
              className="h-16 sm:h-20 w-auto object-contain border border-amber-300"
