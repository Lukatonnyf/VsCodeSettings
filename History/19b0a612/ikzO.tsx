...
export default function ImageCarousel() {
  ...
  useEffect(() => {
    ...
    const imageWidth = 50; // Largura da imagem definida no Image component
    const gapWidth = 35; // Valor de gap-12 (3rem = 48px)
    ...
    timelineRef.current = gsap.to(carouselElement, {
      x: `-=${widthOfOneSet * 100}`, // Move para a esquerda pela largura de um conjunto de logos
