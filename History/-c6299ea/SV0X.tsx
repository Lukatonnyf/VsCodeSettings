...
const Project2 = () => {
  return (
    <Cards className="w-[70dvw] h-[57dvh] flex flex-col md:flex-row justify-center items-center
    ...
    rounded-xl backdrop-blur-md">
      ...
      <div className="w-full lg:w-2/3 h-full flex justify-center items-center ">
