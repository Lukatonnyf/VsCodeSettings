...
export default function Activitys() {
        const [showCreateAct, setShowCreateActivity] = useState(false)
    ...
    return (
        <div className="flex flex-col gap-5 w-full h-[50dvh] p-5 border border-blue-400">
            <button onClick={() => setShowCreateActivity(!showCreateAct)}  className="w-[30dvh] bg-purple-500 font-semibold text-sm text-gray-100 rounded-2xl p-3 tracking-[1px]">Adicionar Atividade</button>
            {showCreateAct &&  (
                <li className=" absolute z-10  top-100 text-amber-200">mostrando</li>
            )  }
