...
const AboutProject = () => {
  ...
  return (
    <div className="w-full min-h-screen h-full bg-background ">
      <section className="w-full h-full px-5 flex flex-col justify-center items-center
        ...
        max-w-2xl gap-2 lg:flex-row lg:max-w-4xl lg:gap-5'>
          ...
          <div className='w-full '>
            <div className="w-full justify-start  flex flex-col items-start mb-2" >
              ...
              <h2 className='flex gap-2 font-semibold'>{projeto.name}
                <span className='text-text font-normal '>
                  <a href={projeto.link} target='_blank' className='border-b border-b-gray-400'>Link</a></span>
              </h2>
            </div>
          ...
          <div className=" flex flex-col gap-2 justify-start mt-4">
            ...
            <p className='text-sm flex flex-col font-semibold'>
              Descrição:
              <span className='font-normal text-sm sm:text-sm'>
