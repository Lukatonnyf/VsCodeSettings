    ...
    const timer = setTimeout(() => {
      ...
      if (text2.current) {
        gsap.fromTo(
          text2.current,
          { opacity: 0, x: -50 },
          { opacity: 1, x: 0, duration: 0.5, ease: 'power2.out', delay: 1.2 }
        );
      }
      ...
      if (btnDescobrirRef.current) {
        gsap.fromTo(
          ...
          { opacity: 0, y: 50 },
          { opacity: 1, y: 0, duration: 0.5, ease: "none", delay: 1.4 }
        );
      }
      ...
      if (btnFraganciasRef.current) {
        gsap.fromTo(
          ...
          { opacity: 0, y: 50 },
          { opacity: 1, y: 0, duration: 0.5, ease: "none", delay: 1.3 }
        );
      }
    }, 0);
          ...
          <div className="flex flex-col gap-6 max-w-xl">
            <span className='flex flex-col'>
              <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl"
                style={{ opacity: 1 }} ref={text1}>Fragrâncias Divinas</h1>
