...
export default function HomePage() {
  const handleRedirectYotube = () => {
    window.location.href = 'https://youtube.com/seucanal'; // Altere para o seu canal
  };
        ...
        <section className=" flex justify-center  flex-col items-center p-5
          ...
          <div className="flex flex-col w-full max-w-2xl  py-2 gap-3">
            ...
            <div className="flex flex-col  min-w-full
             gap-2  w-full">
              <Button text={"Portifólio"} innerRef={null} onClick={handleRedirectYotube} />
              <Button text={"Yotube"} innerRef={null} />
            </div>
          </div>
