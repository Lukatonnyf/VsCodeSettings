     ...
     shadow-custom-purple-700">
      ...
      px-5 lg:flex-row">
        ...
        <section className=" flex justify-center  flex-col items-center p-5
          w-full  h-full gap-5 lg:gap-10 border  border-btn-socialmedias">

          <div className="flex flex-col w-full max-w-2xl border bg-danger py-2 gap-3">
            ...
            h-full">
              <div className="text-center flex flex-col justify-center items-center">
                <Image
                  src="/teste.jpg"
                  alt="image test"
                  className="object-contain object-center max-w-[30vw]
                  rounded-full"
                  width={150}
                  height={100}
              ...
              <ul>
                <li className="flex flex-row gap-3   ">
                  <ButtonSocialMedia text={<IoLogoInstagram className="text-xs" />}
                    innerRef={null} />

                  <ButtonSocialMedia
                    text={<IoLogoDiscord className="text-xs" />}
                    innerRef={null} />

                  <ButtonSocialMedia
                    text={<IoLogoLinkedin className="text-xs" />}
                    innerRef={null} />
                </li>
              </ul>
            </div>
