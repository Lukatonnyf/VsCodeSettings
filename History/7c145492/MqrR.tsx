     ...
     shadow-custom-purple-700">
      ...
      px-5 lg:flex-row">
        ...
        <section className=" flex justify-center  flex-col items-center p-5
          ...
          <div className="flex flex-col w-full max-w-2xl border bg-danger  min-h-[35dvh] gap-3">
            ...
            h-full">
              ...
              <ul>
                <li className="flex flex-row gap-3   ">
                  <ButtonSocialMedia text={<IoLogoInstagram className="text-sm lg:text-xs" />}
                    innerRef={null} />

                  <ButtonSocialMedia
                    text={<IoLogoDiscord className="text-sm lg:text-xs" />}
                    innerRef={null} />

                  <ButtonSocialMedia
                    text={<IoLogoLinkedin className="text-sm lg:text-xs" />}
                    innerRef={null} />
                </li>
              </ul>
            </div>
