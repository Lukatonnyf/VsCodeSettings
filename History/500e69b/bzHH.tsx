...
export default function Footer() {
  ...
  const urlEmail = `mailto:${email}?subject=${encodeURIComponent}&body=${encodeURIComponent(corpo)}`;
  ...
  return (
    ...
    gap-3 bg-gradient-to-b from-black to-[#0a0a0a] border border-t-[#121212]">
      ...
      <ul className="text-gray-400 flex flex-col gap-5 bg-[#0]
      max-w-[50dvh] w-full  justify-between items-center py-2 pb-3 ">
