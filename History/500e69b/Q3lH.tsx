...
export default function Footer() {
  return (
    <div className="flex flex-col justify-center items-center w-full h-[auto] py-3
    gap-3 bg-gradient-to-b from-black to-[#0a0a0a0] border border-t-[#121212]">
      ...
      <ul className="text-gray-400 flex flex-col gap-2 bg-[#121212]
      w-full justify-center items-center ">
        <li >
          <h1 className="text-gray-100 text-lg font-bold">Desenvolvedor</h1>
          <p >
