...
const Project = () => {
  ...
  return (
    ...
    <div
      ...
      ref={containerRef}>
      <div className="relative max-w-[1240px] w-full h-full  flex justify-center items-center">
        {
          componentsArray.map((component, i) => (
            <div
              ...
              md:items-center  max-w-full flex justify-center items-center"
              style={{ zIndex: i + 1 }}>
              <div className="pointer-events-auto min-w-full">
                {component.element}
              </div>
            </div>
          ))
