    ...
    <div ref={headerRef}
      ...
      <div
        ...
        <div className='hidden md:flex gap-5 '>
          <Button className="border border-borderbd px-3 bg-background" >Entrar em Contato</Button>
          <Button className="border border-borderbd px-3 bg-background" >Meu Linktree </Button>
