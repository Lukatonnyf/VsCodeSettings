...
const Footer = () => {
  ...
  const mensagem = 'Olá! Vi seu portfólio e me interessei pelo seu trabalho. Quero
  tirar meu projeto do papel e gostaria de conversar com você!';
  ...
  return (
    <div
     ...
     gap-5 p-5 w-full">
        ...
        p-px">
          <Button
            onClick={() => window.open(numeroWhatsApp, '_blank')}
