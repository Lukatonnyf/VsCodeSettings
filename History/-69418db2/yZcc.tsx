        ...
        md:justify-center md:items-center">
          ...
          <div className="flex flex-col gap-6 max-w-xl">
            <span className='flex flex-col'>
              ...
              <h2 className="font-semibold text-md sm:text-xl md:text-1xl" ref={text2}>Essência da Elegância</h2>

              <span className='flex flex-col p-0 text-xs md:text-sm  lg:text-xs  sm:border-red-400 border' ref={text3}>
