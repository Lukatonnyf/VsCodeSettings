...
export default function HomePage() {
  ...
  const numeroWhatsApp = '5511934092531'; // Número no formato internacional
  const mensagem = 'Olá, gostaria de saber mais informações sobre os perfumes!'; // Mensagem pré-pronta
