        ...
        md:justify-center md:items-center">
          ...
          <div className="flex flex-col gap-6 max-w-xl">
            <span className='flex flex-col'>
              <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-4x" ref={text1}>Fragâncias Divinas</h1>
              <h2 className="font-semibold text-md sm:text-xl md:text-1xl sm:border-red-400 border" ref={text2}>Essência da Elegância</h2>

              <span className='flex flex-col p-0  text-sm md:text-sm lg:text-xs' ref={text3}>
                Perfumes que não apenas marcam, mas eternizam momentos.
              </span>

            </span>

            <div className="flex flex-col items-center gap-2 w-full  lg:flex-row">
              ...
              <div className=" w-full hover:scale-100">
                ...
                <Button innerRef={btnDescobrirRef} text={'Entrar em Contato'}
                  className="text-white  transition   " onClick={() => window.open(urlWhatsApp, '_blank')} />
              </div>
