        ...
        md:justify-center md:items-center">
          ...
          <div className="flex flex-col gap-6 max-w-xl">
            <span className='flex flex-col'>
              <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl" ref={text1}>Fragâncias Divinas</h1>
              <h2 className="font-semibold text-xl sm:text-xl" ref={text2}>Essência da Elegância</h2>
