        ...
        md:justify-center md:items-center">
          ...
          <div className="flex flex-col gap-6 max-w-xl">
            <span className='flex flex-col'>
              <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl" ref={text1}>Fragâncias Divinas</h1>
              <h2 className="font-semibold text-md sm:text-xl md:text-1xl lg:text-4xl " ref={text2}>Essência da Elegância</h2>

              <span className='flex flex-col p-0 text-xs md:text-sm  lg:text-sm  ' ref={text3}>
                Perfumes que não apenas marcam, mas eternizam momentos.
              </span>

            </span>

            <div className="flex flex-col items-center gap-2 w-full  lg:flex-row lg:gap-0 border">
              <div className="w-full hover:scale-100">
                <Button innerRef={btnFraganciasRef} text={'Descobrir mais'}
                  className="bg-white text-black   " onClick={handleScroll} />
              </div>
              <div className=" w-full hover:scale-100">

                <Button innerRef={btnDescobrirRef} text={'Entrar em Contato'}
                  className="text-white  transition  border  " onClick={() => window.open(urlWhatsApp, '_blank')} />
              </div>
