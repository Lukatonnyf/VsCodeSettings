...
export default function FeedbackFormPage() {
  ...
  function goToFeedbacks() {
    return alert("Desculpe, a página ainda está em desenvolvimento...")
  }
      ...
      {(methods) => (
        <>
          <CardHeader>
            ...
            <CardAction >
              <Button
                onClick={goToPortifolio}
                className="text-[#525252]"
                variant="link" formTarget="_blank">Portifólio</Button>
            </CardAction>
          </CardHeader>
          ...
          <CardContent>
            <section onSubmit={methods.handleSubmit(handleSubmit)}>
              ...
              <CardFooter className="flex-col gap-3 mt-5">
                ...
                <Button onClick={goToFeedbacks} variant="outline" className="w-full">
                  Ver Feedbacks
                </Button>
              </CardFooter>
            </section>
