...
export default function VideoPlayer() {
  ...
  return (
    <div
      id="target-section"
      className=" flex flex-row flex-wrap  justify-center items-center  max-w-full mx-auto w-full  border p-2  min-h-[50dvh]
         h-full xl:max-w-[170dvh] sm:gap-2 "
    >
      <div className="flex flex-col justify-center items-center  w-[70dvh] h-[60dvh]  p-2 gap-5 
       bg-gray-700 border border-gray-500  rounded-2xl lg:gap-0">
        <div className="flex justify-center items-startw-full  p-2 gap-5">
          <Image
            src="/icon.png"
            alt="foto tonny "
      ...
      <div
        className="flex flex-col justify-center items-start bg-gray-700 border border-gray-500 w-full h-[60dvh]
       p-2 gap-5 rounded-2xl  text-gray-300 lg:gap-3 lg:text-sm md:max-w-[50dvh]"
      >
