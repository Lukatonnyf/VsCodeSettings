...
export default function VideoPlayer() {
  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center  w-[70dvh] h-full  p-2 gap-5 bg-blue  lg:gap-0">
        <div className="flex justify-center items-start bg-gray-700 border border-gray-500 w-full  p-2 gap-5">
          <Image
            src="/icon.png"
            alt="foto tonny "
            className="object-cover rounded-full"
            width={300} // Aumentar largura para melhor qualidade
            height={200} // Ajustar altura para manter a proporção
