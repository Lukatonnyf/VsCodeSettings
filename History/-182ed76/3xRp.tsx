...
export default function VideoPlayer() {
  ...
  return (
    <div
      id="target-section"
      className="flex justify-center max-w-full mx-auto w-full   p-2 min-h-[50dvh]
      h-full xl:max-w-[130dvh] sm:gap-2 border "
    >
      <div className="flex flex-wrap flex-col justify-center items-center max-w-full p-2 gap-5 
